...
function BlogDocs() {
  ...
  const blogPosts = [
    {
      ...
      summary: 'As a passionate Node.js Developer I created an architecture with Node.js + Rust tokio runtime.',
      content: `
 ### Introduction
 ...
 ### Rust Napi
 - **Napi-RS:** Rust N-API (or napi-rs) is a tool that allows developers to create native Node.js modules using Rust. This can be particularly beneficial because Rust provides performance and memory safety advantages. Here are some key points about Rust N-API:.
...
//     },
  ...
  return (
    <section id="blog" className="py-20 bg-gradient-to-b from-gray-400 to-gray-300">
      <div className="container mx-auto px-6">
        <h3 className="text-3xl font-semibold text-center mb-12">Blog & Research</h3>
