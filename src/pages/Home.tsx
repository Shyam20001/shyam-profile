  ...
  return (
    <Layout title="Home Page" description="Welcome to the home page">
      <div className="container mx-auto p-6 bg-gray-100 rounded-lg shadow-lg">
        ...
        <ul className="list-disc list-inside mb-6 space-y-4">
          {props.messages.map((message, index) => {
            return (
              <li
                key={index}
                className="text-xl text-gray-800 bg-white p-4 rounded-lg shadow hover:bg-blue-50 transition duration-200 ease-in-out"
              >
                {message}!!
              </li>
            );
        ...
        <div id="message" className="mt-4 text-gray-700 font-medium"></div>{' '}
